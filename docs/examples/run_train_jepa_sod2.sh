#!/usr/bin/env bash
# Phase A: train cell-trajectory JEPA on LPS (sod2 outputs, GPUs 5,6,7).
set -euo pipefail
...
CKPT_MASKING="${WORKSPACE}/T_perturb/res/masking/checkpoints/20260729_1751_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_ptime_pos_sin_m_pow_tp_1-2-3_s_0-epoch=19.ckpt"
ENCODER="${REPO}/pretraining_cohort/20250709_1223_cellgen_train_masking_lr_5e-05_wd_1e-06_batch_64_ptime_pos_sin_m_pow_tp_1-2-3_s_42-epoch=00.ckpt"
